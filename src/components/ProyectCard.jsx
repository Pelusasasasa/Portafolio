...
const ProyectCard = ({title,description,image}) => {
  return (
    <div className="border flex flex-col h-full border-white rounded-2xl hover:cursor-pointer hover:bg-slate-500 ">
      <figure >
        <Image className="rounded-t-2xl h-40 object-cover border-b" alt={title} src={image}/>
      </figure>
